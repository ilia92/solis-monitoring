...
SENSORS = [
    ...
    {"key": "grid_current_l1",                   "name": "Grid Current L1",                  "registers": [33252],        "type": "s16",  "unit": "A",   "scale": 0.1},
    {"key": "grid_voltage_l2",                   "name": "Grid Voltage L2",                  "registers": [33253],        "type": "u16",  "unit": "V",   "scale": 0.1},
    {"key": "grid_current_l2",                   "name": "Grid Current L2",                  "registers": [33254],        "type": "s16",  "unit": "A",   "scale": 0.1},
    {"key": "grid_voltage_l3",                   "name": "Grid Voltage L3",                  "registers": [33255],        "type": "u16",  "unit": "V",   "scale": 0.1},
    {"key": "grid_current_l3",                   "name": "Grid Current L3",                  "registers": [33256],        "type": "s16",  "unit": "A",   "scale": 0.1},
